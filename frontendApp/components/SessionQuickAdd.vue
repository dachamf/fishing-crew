...
const { stackCatch } = useMySessions()
...
<template>
  <div class="grid gap-2 md:grid-cols-4">
    ...
    <input v-model.number="form.weight_kg" type="number" step="0.001" class="input input-bordered"
           placeholder="Težina (kg) — opcionalno"/>
    <button :disabled="!form.species || loading" class="btn btn-primary" @click="addCatch">
      + Dodaj
    </button>
    <textarea v-model="form.note" class="textarea textarea-bordered md:col-span-4" rows="2"
