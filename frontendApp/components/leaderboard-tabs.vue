  ...
  <TabGroup>
    <TabList class="tabs tabs-bordered mb-4">
      <Tab v-slot="{ selected }" as="template">
        <button :class="['tab', selected && 'tab-active']">Aktivnost</button>
      </Tab>
      <Tab v-slot="{ selected }" as="template">
        <button :class="['tab', selected && 'tab-active']">Ukupna težina</button>
      </Tab>
      <Tab v-slot="{ selected }" as="template">
        <button :class="['tab', selected && 'tab-active']">Najveći primerak</button>
      </Tab>
    </TabList>
    <TabPanels>
