...
import type { FishingCatch, FishingSession, SessionListParams } from "~/types/api";
...
<template>
  <div class="container mx-auto p-4 space-y-4">
    <div class="flex flex-wrap items-center gap-3 justify-between">
      ...
      <NuxtLink class="btn btn-primary btn-sm" to="/catches/new">
        + Novi ulov
      </NuxtLink>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="stats bg-base-200 shadow hidden md:grid">
              ...
              <div class="stat">
                ...
                <div class="stat-value">
                  {{ getAgg(s).totalWeight.toFixed(1) }} kg
                </div>
              </div>
              <div class="stat">
                <div class="stat-title">
                    ...
                    <div class="flex items-center gap-2">
                      <div class="avatar">
                        <div class="w-6 rounded-full overflow-hidden border border-base-300">
                          <img
                            :src="row.user?.profile?.avatar_url || '/icons/icon-64.png'"
                            alt=""
                          >
                        </div>
                      </div>
          ...
          <div class="stats bg-base-200 shadow md:hidden mt-3">
            ...
            <div class="stat">
              ...
              <div class="stat-value">
                {{ getAgg(s).totalWeight.toFixed(3) }} kg
              </div>
            </div>
            <div class="stat">
              <div class="stat-title">
