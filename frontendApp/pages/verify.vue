...
<template>
  <div class="max-w-lg mx-auto p-6 space-y-4">
    ...
    <p v-if="status === 'success'">
      Hvala! Tvoja email adresa je uspešno verifikovana. Možeš nastaviti sa aplikacijom.
    </p>
    <p v-else-if="status === 'already-verified'">
      Email je već verifikovan.
    </p>
    <p v-else>
      Proveri inbox i klikni na link za potvrdu.
    </p>
