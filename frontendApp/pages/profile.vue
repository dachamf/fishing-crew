...
const { profile, updateProfile, uploadAvatar, deleteAvatar, changePassword, avatarBuster }
  = useProfile();
...
<template>
  <div class="max-w-3xl mx-auto p-6 space-y-8">
    ...
    <section class="card bg-base-100 shadow p-4">
      <h2 class="font-medium mb-3 text-info">
        Avatar
      </h2>
    ...
    <section class="card bg-base-100 shadow p-4">
      ...
      <div class="flex items-center gap-3">
        <button
          :class="mode === 'light' ? 'btn-primary' : 'btn-ghost'"
          :disabled="busy"
          class="btn"
          @click="choose('light')"
        >
        ...
        <button
          :class="mode === 'dark' ? 'btn-primary' : 'btn-ghost'"
          :disabled="busy"
          class="btn"
          @click="choose('dark')"
        >
        ...
        <button
          :class="mode === 'system' ? 'btn-primary' : 'btn-ghost'"
          :disabled="busy"
          class="btn"
          @click="choose('system')"
        >
